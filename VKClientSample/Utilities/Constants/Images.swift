...
extension UIImage {
    ...
    static let heartIcon = UIImage(imageLiteralResourceName: "heartIcon")
    static let heartFill = UIImage(imageLiteralResourceName: "heartFill")
    static let commentIcon = UIImage(imageLiteralResourceName: "commentIcon")
    static let shareIcon = UIImage(imageLiteralResourceName: "shareIcon")
